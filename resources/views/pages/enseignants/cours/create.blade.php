...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Ajouter un cours</h4>
        </div>
    ...
    <div class="row">
        <div class="col-12 col-xl-12 grid-margin stretch-card">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <form class="forms-sample row" action="{{ route('teachers.courses.store', $enseignant) }}" method="post">
                        @csrf
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group date timepicker" id="datetimepickerExample" data-target-input="nearest">
                                <input value="{{ old('horaire_debut') }}" id="horaire_debut" name="horaire_debut" placeholder="Horaire" type="text" class="form-control datetimepicker-input" data-target="#datetimepickerExample">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group date timepicker" id="datetimepicker" data-target-input="nearest">
                                <input value="{{ old('horaire_fin') }}" id="horaire_fin" name="horaire_fin" placeholder="Horaire" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="matiere_id" name="matiere_id">
                                @foreach($matieres as $matiere)
                                    <option @selected(old('matiere_id') == $matiere->id) value="{{ $matiere->id }}">{{ $matiere->libelle_matiere }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="classe" name="type_cours">
                                <option @selected(old('type_cours') == 'TD') value="TD">TD</option>
                                <option @selected(old('type_cours') == 'TP') value="TP">TP</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="ue_id" name="ue_id">
                                @foreach($ues as $ue)
                                    <option @selected(old('ue_id') == $ue->id) value="{{ $ue->id }}">{{ $ue->libelle }}</option>
                                @endforeach
                            </select>
                        </div>
