...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Ajouter un enseignant</h4>
        </div>
    ...
    <div class="row">
        <div class="col-12 col-xl-12 grid-margin stretch-card">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <form class="forms-sample row" action="{{ route('teachers.store') }}" method="post">
                        @csrf
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input value="{{ old('responsabilite_enseignant') }}" type="text" class="form-control"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select" id="role_id" name="role_id">
                                <option @selected(old('role_id') == 3) value="3">Directeur département</option>
                                <option @selected(old('role_id') == 2) value="2">Directeur d'étude</option>
                            </select>
                        </div>
