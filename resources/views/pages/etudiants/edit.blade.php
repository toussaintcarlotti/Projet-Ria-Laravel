...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Modifier un étudiant</h4>
        </div>
    ...
    <div class="row">
        <div class="col-12 col-xl-12 grid-margin stretch-card">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <form class="forms-sample row" action="{{ route('students.update', $etudiant) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6 mb-3">
                            <label for="nom" class="form-label">Nom</label>
                            <input type="text" class="form-control" id="nom"
                                   value="{{ old('nom', $etudiant->user->nom) }}" placeholder="nom" name="nom">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input value="{{ old('email', $etudiant->user->email) }}" type="email" class="form-control"
                                   id="email"
